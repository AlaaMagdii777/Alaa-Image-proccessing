...
export const visualDesignGalleryDir = path.resolve(__dirname,'./../galleries/visualDesignGallery');
//Source Gallery
const source = path.resolve(galleryDir, 'icelandwaterfall.jpg');
//Target title with dimensions
const target = path.resolve(visualDesignGalleryDir,'title=icelandwaterfall&width=500&height=800.jpg');
